...
/*
        ...
        float h = getHeight();
        float w = getWidth();
        //float offsetTop = (h/2) - h/8 ;
        //float offsetBottom = (h/2) + h/8 ;
        hasScrolled = true;
        if (isDraggin)
            return false;
...
/*if (mOnDragListener != null && (distanceX < 35 && distanceX > -35) &&
            ...
            if (!isDraggin) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    item2.startDrag(data, shadowBuilder, item2, 0); //TODO Attempt to read from field 'android.view.IWindowSession android.view.View$AttachInfo  on a null object reference
                }
