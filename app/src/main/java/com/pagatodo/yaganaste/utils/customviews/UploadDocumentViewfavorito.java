...
public class UploadDocumentViewfavorito extends RelativeLayout {
...
//    TextView tv_name;
    ...
    public UploadDocumentViewfavorito(Context context) {
        super(context);
        init();
    }

    public UploadDocumentViewfavorito(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public UploadDocumentViewfavorito(Context context, AttributeSet attrs, int defStyleAttr) {
