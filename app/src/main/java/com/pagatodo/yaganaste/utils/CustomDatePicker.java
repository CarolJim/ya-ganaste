 ...
 * guide.
 */
public class CustomDatePicker extends AlertDialog implements OnClickListener,
     ...
     *                   on month)
     */
    public CustomDatePicker(@NonNull Context context, @Nullable android.app.DatePickerDialog.OnDateSetListener listener,
    ...
    private CustomDatePicker(@NonNull Context context, @StyleRes int themeResId,
        ...
        setButton(BUTTON_POSITIVE, themeContext.getString(R.string.title_aceptar), this);
        setButton(BUTTON_NEGATIVE, themeContext.getString(R.string.title_cancelar), this);
