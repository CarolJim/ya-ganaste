...
public class AsignarPinTextWatcher implements TextWatcher {
    ...
    public AsignarPinTextWatcher(EditText edtMount, TextView tvMontoEntero, TextView tvMontoDecimal) {
