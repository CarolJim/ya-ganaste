...
public class CardEmisorSelected extends TabViewElement {
    ...
    public void updateData() {
        UsuarioResponse userData = SingletonUser.getInstance().getDataUserUyu().getUsuario();

        ClienteResponse clienteData= SingletonUser.getInstance().getDataUserUyu().getCliente();
