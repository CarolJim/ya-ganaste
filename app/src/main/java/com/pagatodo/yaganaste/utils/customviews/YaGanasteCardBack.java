...
public class YaGanasteCardBack extends AppCompatImageView {
    ...
    public YaGanasteCardBack(Context context) {
        super(context);
        initView(context, null);
    }

    public YaGanasteCardBack(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public YaGanasteCardBack(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        setImageResource(R.mipmap.main_card_zoom_blue_back);
