...
public abstract class AppDatabase extends RoomDatabase {
    ...
    static final Migration MIGRATION_1_2 = new Migration(1, 2) {
        ...
        public void migrate(SupportSQLiteDatabase database) {
            database.execSQL("CREATE TABLE `Agentes` (`numero_agente` TEXT NOT NULL, `es_comercio_uyu` INTEGER NOT NULL, `folio` TEXT, `id_estatus` INTEGER NOT NULL, `nombre_negocio` TEXT, PRIMARY KEY(`numero_agente`))");
