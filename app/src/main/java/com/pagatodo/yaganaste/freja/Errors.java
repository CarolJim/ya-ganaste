...
public enum  Errors {
    ...
    NO_ACTIVATION_CODE(1,""),
    NO_PIN_POLICY(1,""),
    NO_NIP(1,""),
    BAD_CHANGE_POLICY(1,""),
    NO_PENDING_TRANSACTIONS(1,""),
    NO_OFFLINE_TOKEN(1,""),

    E1(5002, "Unspecified exception occurred when trying to connect to MASS"),
    E2(5005, "The user’s smartphone does not have Internet access, possibly due to Airplane mode being activated"),
    E3(5006, "Connection with MASS timed out since the server took too long to respond"),
    E4(5007, "Certificate validation failed"),
    E5(5008, "SSL connection cannot be established"),
    E6(500, "Internal server error – please contact Verisec support"),
    E7(600, "The REST message received has an invalid format and MASS is unable to parse it"),
    E8(1001, "The current version of Freja Mobile Core is out of date and no longer supported. The user should be prompted to update the application before proceeding"),
    E9(1002, "MASS has received a request related to an unknown token serial number"),
    E10(1004, "An irregularity occurred in the session between Freja Mobile Core and MASS"),
    E11(1005, "Session has expired"),
    E12(1020, "Online token has been locked due to too many failed authentication attempts. If this occurs, the token is no longer usable until a PIN reset is performed"),
    E13(1029, "None of the provided protocol versions are supported. This error is shown if mobile " +
            "application and MASS do not use the same protocol for communication. One or both components should be upgraded"),

    E14(1000,"MASS has received an activation code which does not exist in its database"),
    E15(1003,"MASS has received a provisioning request for both an online and an offline token. However, their respective serial numbers are not associated with the same activation code"),
    E16(1006,"Activation code has expired"),
    E17(1007,"A provisioning method has been called, but it cannot be applied because the provisioning process is currently in a state which does not allow it"),
    E18(1008,"MASS has received a request to confirm the completion of provisioning. However, provisioning has already been completed"),
    E19(2000,"Client code does not exist"),
    E20(1036,"(Notification) Failed to set mobile token info"),
    E21(1009,"(Transaction) Another transaction is already in progress"),
    E22(1010,"(Transaction) MASS has received a message inquiring about an ongoing transaction for " +
               "a given serial number, but the token in question does not currently have a transaction associated with it"),
    E23(1011,"(Transaction) Transaction has expired"),
    E24(1012,"(Transaction) A transaction-related method has been called, but it cannot be applied " +
               "because the transaction process is currently in a state which does not allow it"),
    E25(1013,"(Transaction) A transaction could not be confirmed"),
    E26(1015,"PIN change was initiated and failed"),

    E27(1022,"Reset PIN) There is no RPC or RPC expired."),
    E28(1023,"Reset PIN) Invalid RPC hash or value."),
    E29(1024,"Reset PIN) Remaining try attempts for given reset PIN code is 0."),
    E30(1025,"Reset PIN) Calling provisioning method getResetPinPinPolicy failed."),
    E31(1026,"Reset PIN) Calling provisioning method resetPin4RpcCode failed."),
    E32(1027,"Reset PIN) One or more parameters are missing."),
    E33(1028,"Reset PIN) getResetPinPinPolicy must be called first."),
    E34(1033,"Key renewal) Failed to change token key. All errors regarding changing token key can appear if token key renewal is enabled on MASS."),
    E35(1034,"Key renewal) Making this call is not allowed since key renewal is not required."),
    E36(1035,"Key renewal) Making this call is not allowed, key renewal is required."),
    E37(1042,"Invalid PIN. The most likely cause is that the PIN length does not match the PIN policy set on MASS.");
