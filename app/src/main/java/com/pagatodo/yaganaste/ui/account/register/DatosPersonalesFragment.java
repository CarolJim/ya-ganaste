...
public class DatosPersonalesFragment extends GenericFragment implements
    ...
    View.OnClickListener onClickListenerDatePicker = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(), R.style.Theme_AppCompat_Light, new DatePickerDialog.OnDateSetListener() {
                @Override
                public void onDateSet(DatePicker datePicker, int year, int month, int date) {
                    ...
                    if (newDate.getTimeInMillis() > actualDate.getTimeInMillis()) {
                        ...
                        txtfecha.setBackgroundResource(R.drawable.input_text_error);
                        return;
                    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference ref = App.getDatabaseReference().child("Mexico").child("AppEngine").child("CatComponents").child("County");
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    if (editNames.getText().toString().isEmpty()) {
                        ...
                        text_nombre.setBackgroundResource(R.drawable.input_text_error);
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    if (editFirstLastName.getText().toString().isEmpty()) {
                        ...
                        text_apater.setBackgroundResource(R.drawable.input_text_error);
    ...
    public void validateForm() {
        ...
        if (genero == null || genero.equals("")) {
            ...
            generTitle.setBackgroundResource(R.drawable.input_text_error);
            isValid = false;
        }
        ...
        if (lugarNacimiento.isEmpty()) {
            ...
            txtlugarnacimiento.setBackgroundResource(R.drawable.input_text_error);
    ...
    public void showValidationError(int id, Object error) {
        ...
        switch (id) {
            ...
            case R.id.editCountry:
                ...
                lytCountry.setBackgroundResource(R.drawable.input_text_error);
                break;
        }
        UI.hideKeyBoard(getActivity());
