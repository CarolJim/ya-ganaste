...
public class SelectOptionZoneViewHolderReembolso  extends OptionsViewHolder implements View.OnClickListener{
    ...
    public SelectOptionZoneViewHolderReembolso(Activity context, View itemView) {
        super(itemView);
