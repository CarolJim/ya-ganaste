...
public class ElementsWalletAdapter extends RecyclerView.Adapter<OptionsViewHolder> {
    ...
    public ElementsWalletAdapter(Context context, OnItemClickListener listener, List<ElementView> elementViews, int state) {
        ...
        switch (this.state){
            ...
            case 2:
                ...
                if (SingletonUser.getInstance().getDataUser().isEsAgente()
                    ...
                    op = new IndicationZoneViewHolder(this.context,inflater.inflate(R.layout.indicator_zone_tipo_uno, parent, false));
